...
#define NDI_LIB_MAJOR_VERSION_NUMBER 6
#define NDI_LIB_MINOR_VERSION_NUMBER 0
#define NDI_RUNTIME_NOT_FOUND "NDI_RUNTIME_NOT_FOUND"
#define NDI_RUNTIME_VERSION_MISMATCH "NDI_RUNTIME_VERSION_MISMATCH"
